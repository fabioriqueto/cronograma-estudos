    ...
    for disc in disciplinas:
        ...
        if unidades:
            ...
            for i, unidade in enumerate(unidades):
                ...
                # - cada exercício conta 100% se 'feito' ou 'leitura' for True
                ...
                concluidos_exerc = sum(1 for e in exercicios if e.get("feito") is True or e.get("leitura") is True)
            ...
            for u_idx, unidade in enumerate(unidades):
                ...
                for exercicio in ex_list:
                    ...
                    if titulo_exercicio:
                        ...
                        # Determinar se entregue ou pendente
                        entregue = feito or (data_entrega_real is not None)
                        status_color = "darkgreen" if entregue else "#e65100"
                        status_text = "[Entregue]" if entregue else "[Pendente]"
                        ...
                        ax.text(
                            ...
                            fontsize=6,
                            color=status_color,
                            fontweight="bold" if not entregue else "normal"
                        )
                        y_exercicios -= 1.0
